...
class GetOnTheAirTvUsecase extends BassUseCase<List<Tv>, NoParameters> {
  final BaseTvRepository _baseTVRepository;

  GetOnTheAirTvUsecase(this._baseTVRepository);

  @override
  Future<Either<Failure, List<Tv>>> call(NoParameters parameters) async {
    return await _baseTVRepository.getOnTheAirTv();
  }
}
